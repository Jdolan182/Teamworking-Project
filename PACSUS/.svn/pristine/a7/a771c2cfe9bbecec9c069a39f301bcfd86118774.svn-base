...
public class Vehicle_info {
    ...
    public Vehicle_info(Permit P, String regNo, String make, String model, String colour){
    ...
    public void issueWarning(String regNo){
    	...
    	lnkPermit.issueWarning(regNo);
    }
    
    public void deleteWarning(){
    	
    	lnkPermit.deleteWarning();
    }    
    
    
    public void deleteAllWarnings(){
    	
    	lnkPermit.deleteAllWarnings();
    }
    ...
    public String getPermitHolder(){
    	...
    	return lnkPermit.getPermitHolder();
    }
    
    
    public String getPermitType(){
    	
    	return(this.lnkPermit.getPertmitType());	    	
    }
    
    
    public int getEntries(){
    	
    	return(this.lnkPermit.getNoOfEntries());   	
    }
    
    
   public int getWarnings(){
    	
	   return(this.lnkPermit.getWarnings());
    }
   
   
   public Boolean getSuspended(){
   	
	   return(this.lnkPermit.getSuspended());
   }
   
   
   public Boolean getEnteredToday(){
   	
	   return(this.lnkPermit.getEnteredToday());
   }   
