...
public class Barrier extends JFrame implements Observer, ActionListener{
	...
	public Barrier(System_status systemStatus, Vehicle_list vehicleList, int x, int y, String title) {
	...
	public void actionPerformed(ActionEvent e) {		
		...
		if(e.getSource() == submit){
			...
			if(e.getSource() == vehicleClear){
				...
				//regNo = regPlate.getText();
				//lnkSystem_status.addEntry(regNo);
				lnkVehicle_list.setEnteredToday(reg);
				lnkVehicle_list.plusOneEntries(reg);
